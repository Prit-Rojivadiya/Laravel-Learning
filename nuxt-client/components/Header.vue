  ...
  >
    ...
    >
      ...
      <v-list>
        ...
        <div class="subtitle-2 error--text font-weight-regular px-4 pb-2 link-item">
          4 new Messages
        </div>
        <v-list-item-group color="primary">
          <v-list-item
          ...
          >
            ...
            <v-list-item two-line>
              <v-list-item-content style="width: 190px">
                <v-list-item-title class="pb-2" v-text="item.name" />
                <v-list-item-subtitle class="text-truncate" v-text="item.message" />
              </v-list-item-content>
            </v-list-item>
          </v-list-item>
        </v-list-item-group>
      ...
      <v-list>
        ...
        <v-list-item-group color="primary">
          ...
          >
            ...
            <v-list-item-content>
              <v-list-item-title color="#B9B9B9" v-text="item.text" />
            </v-list-item-content>
          </v-list-item>
        </v-list-item-group>
        <div class="d-flex justify-center my-3">
