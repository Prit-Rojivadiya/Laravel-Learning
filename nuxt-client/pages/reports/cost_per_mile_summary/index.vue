<template>
  <div>
    <div class="mb-5">
      <v-row>
        <v-col>
          <h2>Cost Per Mile Summary (CPM) Report</h2>
        </v-col>
      </v-row>
      <v-row>
        <v-col>
...
import CPMMonthByCategoryGrid from "~/components/dashboards/cost_per_mile/MonthByCategoryGrid";
...
export default {
  ...
  methods: {
    ...
    gridDataLoaded (gridData, summaryTypes) {
